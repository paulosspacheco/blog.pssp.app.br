# **Teoria sobre o Framework npm** <a href="teoria_npm_js.html" target="_blank" title="Pressione aqui para expandir este documento em nova aba.">↵</a><a href="teoria_npm_js.pdf" target="_blank" title="Pressione aqui para visualizar o PDF deste documento em nova aba.">℘</a>
...
## CONTEÚDO
  ...
  1. **Objetivo do pacote npm**
     ...
     1. Gerenciador de pacotes de software
  ...
  2. **Arquivo package.json do Node.js**
     ...
     2. O arquivo package.json é um elemento-chave em muitas aplicações do ecossistema Node.js e ele é criado com o comando:
        1. <pre>$ npm init</pre>
           1. O comando npm init fará as perguntas a seguir:
  ...
  5. **HISTÓRICO**
      ...
      2. 04/02/2021 <!--FIXME: em: 04/02/2021-->
