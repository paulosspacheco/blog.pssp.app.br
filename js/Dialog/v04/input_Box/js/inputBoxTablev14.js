...
.inputBox-footer-panel {                
    ...
    GetPainel(owner) {
        ...
        // Verifica se o 'owner' é um dialog
        if (owner instanceof HTMLDialogElement) {
            // Adiciona o botão OK
            const buttonOk = document.createElement('button');
            buttonOk.textContent = 'OK';
            buttonOk.addEventListener('click', () => {
                owner.close('ok'); // Fecha o dialog com valor de retorno 'ok'
            });
            footerPanel.appendChild(buttonOk);
    
            // Adiciona o botão Cancel
            buttonCancel.addEventListener('click', () => {
                owner.close('cancel'); // Fecha o dialog com valor de retorno 'cancel'
            });
        }
    ...
    addFieldsToTable(dialog) {
        ...
        let auxPanel = this.GetPainel(dialog);
        // Adiciona o rodapé ao contêiner principal        
        if (auxPanel) { // Verifica se auxPanel existe
    ...
    addFieldsToDialog() {
        ...
        const container = this.addFieldsToTable(dialog);
