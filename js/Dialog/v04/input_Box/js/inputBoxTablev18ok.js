export class InputBox {
    ...
    addStyles() {
        ...
        style.textContent = `
            ...
            .inputBox-container {        
                margin: 0; /* Remove margens dos elementos filhos diretos */            
                display: flex;
                flex-direction: column; /* Alinha os elementos em coluna */

                max-height: calc(85vh - 1px); /* Subtraia a altura do título se necessário */    
                height: 98%; /* Ocupa toda a altura disponível */

                 max-width: calc(58vw - 1px);
            ...
            .inputBox-dialog {
                ...
                background-color: white; /* Cor de fundo do diálogo */
                border-radius: 5px;
                box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);
                z-index: 1001; /* Coloca o diálogo acima do overlay */
                display: none; /* Inicialmente oculto */
                /* padding: 20px; /* Espaçamento interno */
                width: 90%; /* Largura do diálogo é 90% da largura da viewport */
                max-width: 800px; /* Largura máxima do diálogo */
                max-height: 90vh; /* Altura máxima de 90% da altura da viewport */
    ...
    //     const b = document.getElementById(this.title);
    //     if (b) {
    //         b.style.display = 'none'; // Oculta o diálogo
    //     }        
    }
