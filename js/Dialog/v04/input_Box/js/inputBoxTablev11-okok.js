export class InputBox {
    ...
    addStyles() {
        ...
        style.textContent = `
            ...
            .inputBox-container {        
                ...
                max-height: calc(100vh - 55px); /* Subtraia a altura do título e do painel se necessário */
                /* Remover height: 100%; para evitar conflitos */
    ...
    //     // Cria o painel fixo no rodapé
    //     const footerPanel = document.createElement('div');
    //     footerPanel.className = 'footer-panel'; // Classe CSS para o painel
    
    //     // Adiciona botões ao painel de rodapé
    //     const button1 = document.createElement('button');
    //     button1.textContent = 'Salvar';
    //     button1.onclick = () => { /* Lógica do botão Salvar */ };
    
    //     const button2 = document.createElement('button');
    //     button2.textContent = 'Cancelar';
    //     button2.onclick = () => { /* Lógica do botão Cancelar */ };
    
    //     // Adiciona os botões ao painel
    //     footerPanel.appendChild(button1);
    //     footerPanel.appendChild(button2);
    
    //     // Adiciona o painel ao contêiner
    ...
    addFieldsToTable(title) {
        ...
        titleElement.textContent = title; // Define o texto do título
        ...
        // Adiciona alguns botões de exemplo
        const buttonSave = document.createElement('button');
        buttonSave.textContent = 'Salvar';
        footerPanel.appendChild(buttonSave);
