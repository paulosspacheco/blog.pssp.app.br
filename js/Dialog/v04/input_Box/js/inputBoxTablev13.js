...
.inputBox-footer-panel {                
    ...
    addFieldsToDialog(container) {
        ...
        closeButton.innerHTML = '&times;'; // Símbolo para fechar (X)
        closeButton.onclick = () => this.closeDialog(); // Chama o método para fechar

        header.appendChild(closeButton);
        dialog.appendChild(header); // Adiciona o cabeçalho ao início do diálogo
    ...
    // Método para mostrar o diálogo
    showDialog() {       
        const container = this.addFieldsToTable();
        this.addFieldsToDialog(container);
    }
