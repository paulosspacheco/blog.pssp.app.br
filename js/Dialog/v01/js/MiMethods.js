...
export class MiMethods extends MiConsts{
    ...
    */
    ...
    // Função para incluir o CSS dinamicamente
    // Exemplo de chamada : MiMethods.includeCSS('../css/input_Box.css');
    static includeCSS(href) {
        // Inclui o CSS dinamicamente no documento, verificando se já está presente
        // Verifica se o link já está presente no documento
    ...
    //Método ára ajustar o tamanho da fonte ao redimensionar a janela
    static adjustFontSize(containerSelector, textSelector) {
        const textContainer = document.querySelector(containerSelector);
        const textElement = document.querySelector(textSelector);

        // Verifica se os elementos foram encontrados
        if (!textContainer || !textElement) {
            console.error("Container ou texto não encontrados.");
            return;
        }
        ...
        //    <p>Este é um exemplo de texto cujo tamanho da fonte será ajustado com base na largura do contêiner. Redimensione a janela do navegador para ver as mudanças.</p>
        // </div>

        // Adiciona o evento para ajustar o tamanho da fonte ao redimensionar a janela
        //    window.addEventListener("resize", () => MiMethods.adjustFontSize(".text-container", "p"));
        //    window.addEventListener("load", () => MiMethods.adjustFontSize(".text-container", "p"));
    ...
    // Método para adicionar ao heard um estilo tipo css
    static addStyles(aTextCss) {
        const style = document.createElement('style');
        style.textContent = aTextCss;
        document.head.appendChild(style);
    }    

    // Método para calcular a largura média de um caractere
    static textWidthChar(aFont) {
