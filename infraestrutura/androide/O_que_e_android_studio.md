# <span id="topo"><span>Modelo 03 de documento markdown <a href="O que é Android Studio.html" target="_blank" title="Pressione aqui para expandir este documento em nova aba." >↵</a><a href="O que é Android Studio.pdf" target="_blank" title="Pressione aqui para visualizar o PDF deste documento em nova aba.">℘</a>
...
---
   ...
   3. <span id=id_Conteudo></span>**Conteúdo estudado**
      1. <span id=id_assunto01></span>**Instalação e configuração do IDE**
         ...
         2. **Exemplo do Instalação e configuração do IDE**.
   ...
   5. <span id="id_historico"><span>**HISTÓRICO**
      ...
      2. dd/mm/2021 <!--FIXME: Falta fazer os item abaixo: -->
         - [ ] Criar este documento baseado no O que é Android Studio.md ;
