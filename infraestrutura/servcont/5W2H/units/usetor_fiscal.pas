...
Type
  { TFiscal_5W2H }
  {: A análise [5w2h](https://ferramentasdaqualidade.org/5w2h) do setor fiscal
  ...
  TFiscal_5W2H = class(TAnalise5w2h)
    //{: **Teste de atributos**
    //   - **Este é uma marca do tipo constante**
    //     - 1.0 00
    //     - 1.1 01
    //}
    //Const Test:char = ' ';
    ...
    {: **ONDE SERÁ FEITO**
       ...
       - **PAGAMENTO DOS IMPOSTOS**
          ...
          1. **IMPOSTO SOBRE SERVIÇOS** ([ISS](https://iss.fortaleza.ce.gov.br/grpfor/login.seam?cid=265817))
             ...
             3. **ONDE** Confirmar com o cliente quanto foi suas vendas de serviços:
                1. ,,
             4. **ONDE** Apuração do ISS sobre Venda de Serviços:
                1. ..
             5. **ONDE** Emissão dos boletos de pagamento:
                1. ;;
             6. **ONDE** Envio dos boletos para a caixa postal do cliente:
                1. ..
             7. **ONDE** Confirmar com os clientes se o mesmo recebeu os boletos:
                1. ..

             8. **NOTAS**
                1. **ONDE** pegar os total de clientes que recolhem ISS:
                   1. **ONDE** pegar os ativos:
                      1. ..
                   2. **ONDE** pegar os Inativos:

                2. **ONDE** pegar o total de horas gastas no processo:
                   1. **ONDE** pegar Ativos:
                      1. ..
                   2. **ONDE** pegar os Inativos:
                      1. ...
