...
40 \
"sudo mount -t cifs //ubuntu-server-mate.local/blogger -o username=paulosspacheco,password=Paulo195858,user,dir_mode=0777,file_mode=0777 /home/paulosspacheco/Documentos/blogger"
